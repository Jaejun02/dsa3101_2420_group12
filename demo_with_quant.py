...
def initialize_models(main_model_name, search_model_name, gpu_count, params):
    ...
    try:
        ...
        # Retrieve quantization option and set data type
    ...
    with gr.Blocks(title="ESG Document Extractor") as demo:
        ...
        with gr.Tab("Model Configuration"):
            with gr.Row():
                with gr.Column(scale=1):
                    ...
                    quantization_dropdown = gr.Dropdown(
                        choices=['None', '8-bit', '4-bit', 'fp16'],
                        value='None',
                        label = 'Select Quantization Option'
                    )
            ...
            def init_models(main_model_name, search_model_name, gpu_count, temp, top_p_val, max_tok, 
                           top_k_val, rerank_k_val, alpha_val, quant_choice):
                params = {
                    "temperature": temp,
                    "top_p": top_p_val,
                    "max_tokens": max_tok,
            ...
            initialize_button.click(
                fn=init_models,
                inputs=[
                    main_model_dropdown, search_model_dropdown, gpu_dropdown, quantization_dropdown,
